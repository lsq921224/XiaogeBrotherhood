    ...
    public int[] exclusiveTime(int n, List<String> logs) {
        ...
        for (String log : logs) {
            ...
            if(message[1].equals("start")) {
                if (!stack.isEmpty()) {// cannot be curr_time != -1 since it could start a new one when other fucntions finished.
                    res[stack.peek()] += Integer.parseInt(message[2]) - curr_time;
                }
